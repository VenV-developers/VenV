  ...
  return (
    <>
      <Head>
        <meta
          name="description"
          content="This is the testimonials page of VenV."
        />
        <meta
          name="keywords"
        ...
        <div className="testimonials-container flex-column-mobile">
            ...
            <div>
              <p>
                <span className="quote">
                  " I worked with VenV, they were very helpful and fast to
                  respond to my inquiry to help with website issues and all
                  technical problems. "
                </span>
                <span className="person">Darpan Kadu</span>
                <span className="job">Director - TechInnovate Mobility</span>
              </p>
              <img src="assets/testimonials/testimonial-1.jpeg" alt="" />
            </div>
          </div>
          ...
          <div className="quote-container animated-layer fade-in-right-animation fadeInUp wow">
            <div>
              <p>
                <span className="quote">
                  " VenV just phenomenalized my simple looking school website
                  into a modern and fully dynamic website all things done in the
